...
export async function POST(req: Request) {
  try {
    ...
    // NEW: fulfillment scheduling & pickup & quote meta
    const fulfillment = payload?.fulfillment || null; // { type, scheduleDate, scheduleTime, deliverySpeed }
    ...
    const orderInsert: any = {
      ...
      // IMPORTANT: DB column is fulfillment_status (american spelling)
