...
export default function PendingClient() {
  ...
  // ✅ per-box formatted block sent from /api/checkout
  const boxesText = sp.get("boxes") || "";
  ...
  const lines = [
    ...
    total ? `Subtotal: ${formatIDR(total)}` : "",
    "",
    "Order details (per box):",
    boxesText ? boxesText : "(No box details provided)",
    "",
    "Delivery address:",
    address || "-",
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 16px" }}>
        ...
        >
          ...
          <div style={{ marginTop: 8, color: "#6B6B6B", lineHeight: 1.6 }}>
            Manual payment is active while Midtrans is being verified.
          </div>
...
export default function PendingClient() {
  ...
  const building = sp.get("building") || "";
  const postal = sp.get("postal") || "";
  const items = sp.get("items") || ""; // preformatted text lines
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#FAF7F2" }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 16px" }}>
        <div style={{ borderRadius: 20, border: "1px solid rgba(0,0,0,0.10)", background: "#fff", padding: 18, boxShadow: "0 14px 30px rgba(0,0,0,0.06)", textAlign: "center" }}>
          ...
          <div style={{ marginTop: 14, borderRadius: 16, background: "#FAF7F2", border: "1px solid rgba(0,0,0,0.08)", padding: 12, color: "#3C3C3C", textAlign: "left", lineHeight: 1.6, fontSize: 13 }}>
            <div style={{ fontWeight: 900, marginBottom: 6 }}>Payment instructions</div>
            {manualPayInstructions}
          </div>

          <div style={{ marginTop: 16, display: "grid", gap: 10, justifyItems: "center" }}>
            <a href={waLink} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, padding: "14px 22px", background: "#0052CC", color: "#fff", fontWeight: 950, textDecoration: "none", boxShadow: "0 10px 22px rgba(0,0,0,0.08)", minWidth: 280 }}>
              WhatsApp admin for payment
            </a>
