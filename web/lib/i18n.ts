...
const D: Record<string, { id: string; en: string }> = {
  ...
  // ---- hero + quality strip ----
  "hero.line1": { id: "Dikurasi dengan ", en: "Curated with " },
  "hero.expertise": { id: "keahlian", en: "expertise" },
  "hero.line2": { id: ", diantar untuk ", en: ", delivering to " },
  "hero.you": { id: "kamu", en: "you" },
  "hero.sub": { id: "Produk impor & lokal pilihan, dipilih dengan cermat untuk kualitas, kesegaran, dan kebutuhan harianmu.", en: "Premium imported and local products, handpicked for quality, freshness, and your everyday needs." },
  "hero.shopNow": { id: "BELANJA SEKARANG", en: "SHOP NOW" },
  "hero.chooseStore": { id: "Pilih toko", en: "Choose your store" },
  "strip.qualityT": { id: "Kualitas terjamin", en: "Quality guaranteed" },
  "strip.qualityD": { id: "Kami pilih hanya yang terbaik untukmu dan keluarga.", en: "We source only the best for you and your family." },
  "strip.deliveryT": { id: "Ambil & antar", en: "Pickup & delivery" },
  "strip.deliveryD": { id: "Ambil di toko atau minta diantar ke rumah.", en: "Collect at your store or get it sent to your door." },
  "strip.supportT": { id: "Dukungan ahli", en: "Expert support" },
  "strip.supportD": { id: "Tim kami siap membantu belanjamu dengan tenang.", en: "Our team is here to help you shop with confidence." },
  "shop.stockSyncing": { id: "Stok langsung masih tersinkron dari toko — ketersediaan bisa sedikit tertunda.", en: "Live stock is still syncing from the stores — availability shown may lag." },
  // ---- shop chrome ----
